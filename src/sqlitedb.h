...
class DBTransaction : public QObject {
public:
	explicit DBTransaction(DBBrowserDB* pParent_ = nullptr);
	~DBTransaction();
...
public:
    ...
    **/
	DBTransaction get(const QString& user, ChoiceOnUse choice = ChoiceOnUse::Ask);
